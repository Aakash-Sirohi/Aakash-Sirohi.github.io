...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "All the Personal, Internship and College projects I have worked upon.",
          section: "Navigation",
          handler: () => {
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/RES.pdf";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-bot-detection-system",
          title: 'Bot Detection System',
          description: "Second Major Project completed in college.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/botdetection.html";
            },},{id: "projects-confidentiality-enhanced-cloud-security-model",
          title: 'Confidentiality Enhanced Cloud Security Model',
          description: "Second Minor Project completed in college.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/cecsm.html";
            },},{id: "projects-covid-vaccination-certificate-generator",
          title: 'Covid Vaccination Certificate Generator',
          description: "Application that gives you your Covid-19 Vaccination Certificate.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/cowin.html";
            },},{id: "projects-client-server-socker-implementation-over-cloud-for-the-verification-of-sql-injections-and-buffer-overflow",
          title: 'Client Server Socker Implementation Over Cloud For The Verification of SQL Injections And...',
          description: "First Minor Project completed in College.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/cssiocftvosiabo.html";
            },},{id: "projects-drill-the-lifestyle-app",
          title: 'Drill - The Lifestyle App',
          description: "A Personal Productivity Platform.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/drill.html";
            },},{id: "projects-infosys-infytq",
          title: 'Infosys - INFYTQ',
          description: "Created an ERP System as a part of INFOSYS-INFYTQ internship.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/infytq.html";
            },},{id: "projects-optimized-cloud-security",
          title: 'Optimized Cloud Security',
          description: "First Major Project completed in College.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ocs.html";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%61%6B%61%73%68%73%72%68%77%6F%72%6B@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Aakash-Sirohi", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/aakashsirohi", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/919582834951", "_blank");
        },
      },{
      id: 'light-theme',
